...
description: "What changed in each ant release, newest first."
weight: 40
---
...
For releases before `v0.2.0`, see the [GitHub releases
page](https://github.com/tamnd/ant/releases); each tag carries its full
generated changelog and artifacts.
